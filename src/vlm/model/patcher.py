...
def patch_tokenizer(
    ...
    if model_args.new_special_tokens is not None:
        ...
        if num_added_tokens > 0 and not model_args.resize_vocab:
            ...
            logger.debug("New tokens have been added, changed `resize_vocab` to True.")
...
def patch_config(
    ...
    ) == "internlm3" and not is_transformers_version_greater_than("4.47.1"):
        raise RuntimeError(
...
def patch_model(
    ...
    try:
        ...
        logger.debug("Cannot properly tag the model.")
